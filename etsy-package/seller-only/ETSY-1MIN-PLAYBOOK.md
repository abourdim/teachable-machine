# Teachable Machine for Micro:bit → Etsy 1-Minute Demo Playbook
...
**Title (140 chars max):**
```
Teachable Machine for Micro:bit — BLE Control Panel for Teachers & Kids · Sensors · Servos · Live Graph · 3D Models · No Install · Chrome / Edge
```
...
*Made for Teachable Machine for Micro:bit v1.0.0 — print this on A4, laminate, keep next to the shoot rig.*
